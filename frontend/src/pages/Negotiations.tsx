  ...
  return (
    <DashboardLayout pageTitle="AI Negotiation Workspace Command">
      <div className="space-y-6 text-left">
        ...
        {/* Header Summary */}
        <div>
          <h2 className="text-xl font-bold text-white tracking-tight">AI Negotiation Workspaces</h2>
          <p className="text-xs text-gray-500 mt-0.5">
            Orchestrate contractual terms revisions and review buyer messages with automated LLM classifiers.
          </p>
        </div>
        ...
        {filteredNegotiations.length > 0 ? (
              ...
              <table className="w-full text-xs text-left">
                <thead>
                  <tr className="border-b border-[#161720] text-gray-500 pb-2">
                    ...
                    <th className="py-2.5 font-bold text-right">Negotiation Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#12121A]">
                  {filteredNegotiations.map((neg) => (
                    ...
                    >
                      <td className="py-4 font-bold text-white font-mono flex items-center gap-2">
                      ...
                      <td className="py-4 text-center text-gray-300 font-mono">{neg.target_term} Days</td>
          ...
          <EmptyState 
            title="No active negotiations found"
